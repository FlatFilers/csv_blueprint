...
export const workerDataSheet: Flatfile.SheetConfig = {
  name: 'Worker Data',
  slug: 'workers',
  fields: [
    {
    ...
    {
      key: 'Department_Assignments_Reference_ID',
      label: 'Department Name',
      type: 'reference',
      description:
        'Choose a Department from the dropdown menu. The menu consists of Department you entered into the tenant during an earlier journey.',
      constraints: [{ type: 'required' }],
      config: {
        ref: 'department',
        key: 'name',
